define("DsnPokemonsSection", [
  "RightUtilities",
  "ServiceHelper",
  "ProcessModuleUtilities",
  "DsnPokemonsSectionResources",
  "css!DsnCSSButton",
],
function (RightUtilities, ServiceHelper, ProcessModuleUtilities, resources) {
  return {
      ...
      openApiWindow: function () {
        var controlConfig = {
          PokemonName: {
            ...
            caption: resources.localizableStrings.DsnEnterNamePokemon,
          },
        };
        Terrasoft.utils.inputBox(
          resources.localizableStrings.DsnPokemonName,
      ...
      CountPokemonSubscribe: function () {
        ...
        select.filters.add(
          ...
          Terrasoft.createColumnFilterWithParameter(
            ...
            "DsnLookupPokemon.DsnName",
            pokemon
          )
        );
        select.getEntityCollection(function (result) {
          if (!result.success) {
            this.showInformationDialog(resources.localizableStrings.DsnDataRequestError);
            return;
          }
